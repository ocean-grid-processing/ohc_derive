"""CLI: derive per-product quantities from an ohc_ingest published submission.

    python -m ohc_derive SUBMISSION.nc [--transforms timemean,trend,integral,anomaly,area]
        [--no-ensemble] [--out DIR]
...
from . import loader, transforms
from .ensemble import with_uncertainty


def main():
    ap = argparse.ArgumentParser(prog="ohc_derive")
